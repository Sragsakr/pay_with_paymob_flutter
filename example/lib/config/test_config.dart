...
/// Test/Development configuration — replace with your own keys from https://accept.paymob.com
class TestConfig {
  static AppConfig get config => AppConfig(
    apiKey: "YOUR_TEST_API_KEY",
    publicKey: "egy_pk_test_XXXXXXXXXXXXXXXXXXXXXXXXXXXX",
    secretKey: "egy_sk_test_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
